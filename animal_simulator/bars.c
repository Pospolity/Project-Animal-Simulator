...
void update_bars_value(struct bar * bar, int change) // updates current value of bar. change is added to current value. if any value is lower than 0 gameOver flag is set to true 
{
